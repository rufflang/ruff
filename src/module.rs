...
use crate::errors::{RuffError, ErrorKind};
...
impl ModuleLoader {
	...
	pub fn get_all_exports(&mut self, module_name: &str) -> Result<HashMap<String, Value>, RuffError> {
		let module = self.load_module(module_name)?;
