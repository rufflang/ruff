...
def run_ssg_benchmark() -> tuple[int, float, float, int]:
    file_count = 10_000
    ...
    try:
        ...
        return file_count, elapsed_ms, files_per_sec, checksum
    finally:
        shutil.rmtree(base_dir, ignore_errors=True)


def main() -> None:
    files, elapsed_ms, files_per_sec, checksum = run_ssg_benchmark()
