...
| Spread literals + destructuring bindings | spread + destructuring supported | spread literals supported; destructuring bindings not applied in this scenario | gap remains | `tests/vm_interpreter_parity_surfaces.rs::vm_and_interpreter_document_current_spread_destructuring_gap` |
...
- Until spread/destructuring and match-binding capability gaps are closed, these surfaces should remain in the roadmap as open v1.0.0 work.
